...
var browserCommand = new function(){

  this.getFolders = function( $resourceType, $currentFolder ){
  ...
  this.getFoldersAndFiles = function( resourceType, currentFolder ){
    // Map the virtual path to the local server path.
  ...
  this.createFolder = function( resourceType, currentFolder, newFolderName ){
    var errorNumber = '0';
    var errorMsg    = '';
  ...
  this.fileUpload = function(req, resourceType, currentFolder, sCommand, callback ){
